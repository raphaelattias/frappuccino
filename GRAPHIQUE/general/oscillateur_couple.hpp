...
public:
    ...
    virtual Vecteur evolution2(Vecteur position2_ = {0, 0, 0}, Vecteur vitesse2_ = {0, 0, 0}) const = 0;
...
public:
    virtual Vecteur evolution(Vecteur position_ = {0,0,0}, Vecteur vitesse_ = {0, 0, 0}) const override;
    ...
    virtual Vecteur evolution2(Vecteur position2_ = {0,0,0}, Vecteur vitesse2_= {0,0,0}) const override;
