...
void IntegrateurEulerCromer::integrer(OscillateursCouples &O1, double const& pas_de_temps){
    O1.set_vecteurs(O1.get_position(), O1.get_vitesse() + pas_de_temps*O1.evolution(O1.get_position()), O1.get_position2(), pas_de_temps*O1.evolution2(O1.get_position2()));
    O1.set_vecteurs(O1.get_position() + pas_de_temps*O1.get_vitesse(), O1.get_vitesse(), O1.get_position2()+pas_de_temps*O1.get_vitesse2(), O1.get_vitesse2());
}
